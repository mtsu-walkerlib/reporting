...
CREATE FUNCTION inhouse_check_in(start_date DATE, end_date DATE)
...
WHERE cit.item_status_prior_to_check_in = 'Available'
  AND cit.occurred_date_time >= start_date::timestamp
  AND cit.occurred_date_time <  (end_date + INTERVAL '1day')::timestamp
